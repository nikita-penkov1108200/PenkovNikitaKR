...
{
    public partial class SozdanieDogovora : Form
    {
        private readonly string FileName = @"C:\Users\student251\Desktop\textbox\textbox\textbox\sdelano\sdelano\Kyrsovoi (2)\Kyrsovoi (2)\Kyrsovoi\проект\dok\receipt.docx";
        private DataTable ordersTable = new DataTable();
        private int selectedRow = -1;
        MySqlDataAdapter da;
        public SozdanieDogovora()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (selectedRow != -1)
            {
                ...
                string StartDateOrder = row["StartDateOrder"].ToString();
                ...
                string NameClientDevice = row["NameClientDevice"].ToString();
                ...
                try
                {
                    ...
                    ReplaceWordStub("{StartDateOrder}", StartDateOrder, wordDocument);
                    ...
                    ReplaceWordStub("{NameClientDevice}", NameClientDevice, wordDocument);
